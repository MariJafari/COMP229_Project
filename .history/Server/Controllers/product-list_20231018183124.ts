...
export   ay function ProcessFindProductsByKeyword(req: express.Request, res: express.Response, next: express.NextFunction) :void
{
  try {
    ...
    console.log('Keyword:', keyword);
        ...
        const matchingProducts =  Product.find({ name: { $regex: new RegExp(keyword, 'i') } });
