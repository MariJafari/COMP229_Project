...
export function ProcessEditPage(req: express.Request, res: express.Response, next: express.NextFunction) :void
{
  ...
  ({
   ...
   Product.updateOne({_id:id}, updatedProduct, function(err: CallbackError)
   {
    ...
    res.json({success: true, msg: 'Successfully Added Product', product: updatedProduct});
...
export function ProcessDeletePage(req: express.Request, res: express.Response, next: express.NextFunction) :void
{
    ...
    Product.remove({_id:id}, function(err: CallbackError){
        ...
        res.json({success: true, msg: 'Successfully Deleted Product', product: updatedProduct});
