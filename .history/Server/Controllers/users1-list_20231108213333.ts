...
export   function ProcessFindUserssByKeyword(req: express.Request, res: express.Response, next: express.NextFunction) :void
{
  try {
    ...
    console.log('Keyword:', keyword);
        ...
        Users1.find({ Name: ({ $regex: new RegExp(keyword, 'i') }) }, function (err: any, matchingProducts: any[]) {
            if (err) {
                console.error(err);
